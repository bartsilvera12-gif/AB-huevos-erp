...
const MENU_FAMILIES: { id: string; titulo: string; keys: string[] }[] = [
  ...
  { id: "operaciones", titulo: "Operaciones", keys: ["inventario", "compras", "recetas", "proyectos", "galpones", "clasificacion_huevos"] },
...
export default function Sidebar() {
  ...
  const favoritosItemsFiltered = useMemo(() => {
    ...
    const hiddenSlugs = new Set(["configuracion", "usuarios"]);
