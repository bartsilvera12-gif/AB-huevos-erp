...
const MENU_STRUCTURE: MenuItem[] = [
  ...
  { key: "depositos", slug: "depositos", label: "Depósitos", href: "/depositos", icon: PackageOpen },
  { key: "notas_remision", slug: "notas_remision", label: "Notas de Remisión", href: "/notas-remision", icon: Truck, children: [
    { label: "Historial", href: "/notas-remision" },
    { label: "Emitir NR", href: "/notas-remision/nueva" },
    { label: "Recepción", href: "/notas-remision/recepcion" },
  ] },
...
const MENU_FAMILIES: { id: string; titulo: string; keys: string[] }[] = [
  ...
  { id: "operaciones", titulo: "Operaciones", keys: ["inventario", "compras", "recetas", "proyectos", "galpones", "produccion_huevos", "clasificacion_huevos", "depositos", "notas_remision"] },
