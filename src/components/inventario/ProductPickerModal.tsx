...
export default function ProductPickerModal({
  ...
  // IVA INCLUIDO: el precio unitario ya contiene el IVA. `subtotal` es el total
  // de la línea (precio × cantidad). El IVA se desglosa desde adentro, NO se suma.
  const subtotal = (parseInt(cantidad, 10) || 0) * precioGsEquiv;
  const ivaMonto = iva === "10%" ? subtotal - subtotal / 1.10 : iva === "5%" ? subtotal - subtotal / 1.05 : 0;
