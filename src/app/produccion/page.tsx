  ...
  return (
    <div className="space-y-6">
        ...
        <div className="flex flex-wrap items-start justify-between gap-3">
          <div>
            <h1 className="flex items-center gap-2 text-2xl font-bold text-slate-900">
              <ClipboardList className="h-6 w-6 text-[#4FAEB2]" />
              Producción
            </h1>
            <p className="mt-0.5 text-sm text-slate-500">Recolección diaria de huevos por galpón. Después se pasa a Clasificación.</p>
          </div>
          <button
            type="button"
      ...
      <div className="grid grid-cols-1 gap-3 sm:grid-cols-3">
        <KpiCard label="Registros de producción" value={String(producciones.length)} />
        <KpiCard label="Total huevos" value={fmtNumero(totalHuevos)} accentColor="#0EA5E9" />
        <KpiCard label="Total bajas" value={fmtNumero(totalBajas)} accentColor="#e11d48" />
      </div>
